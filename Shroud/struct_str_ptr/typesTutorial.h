...
// helper capsule_TUT_tutorial_Class1
struct s_TUT_tutorial_Class1 {
    void *addr;     /* address of C++ memory */
    int idtor;      /* index of destructor */
};
typedef struct s_TUT_tutorial_Class1 TUT_tutorial_Class1;
...
void TUT_ShroudArrayStringOut(TUT_SHROUD_array *outdesc, std::string *in, size_t nsize);
#endif
